...
const advantages = [
  ...
  },
  {
    ...
    body: "Fuel your next production directly from the screen. We natively embed sleek, frictionless patronage rails beneath every file. Viewers can instantly back your studio with $5, $10 or $25 capital infusions via Apple Pay or Google Pay while they watch-and you keep 90% of the pool.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="h-7 w-7" aria-hidden>
        <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
      </svg>
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/site/distribute/submit`,
        {
          method: "POST",
      ...
      setError("Something went wrong. Please try again or email us directly at content@brixlore.tv");
    } finally {
      setLoading(false);
    }
  }
    ...
    <>
      <style>{`
        ...
        @keyframes successPulse {
          0%   { box-shadow: 0 0 0 0 rgba(229,231,235,0.35); }
          70%  { box-shadow: 0 0 0 18px rgba(229,231,235,0); }
          100% { box-shadow: 0 0 0 0 rgba(229,231,235,0); }
        }
        .success-ring { animation: successPulse 1.6s ease-out; }
      `}</style>
        ...
        <section className="relative w-full overflow-hidden px-4 py-28 sm:px-6 lg:px-8" aria-label="Hero">
          ...
          <div className="pointer-events-none absolute inset-0" aria-hidden>
            ...
            <div className="absolute inset-0" style={{
              background: "linear-gradient(160deg, rgba(11,11,14,0.72) 0%, rgba(11,11,14,0.45) 50%, rgba(11,11,14,0.65) 100%)",
            }} />
              ...
              >
                ...
                {submitted ? (
                  <div className="flex flex-col items-center py-10 text-center">
                    <div
                      className="success-ring mb-6 inline-flex h-20 w-20 items-center justify-center rounded-full"
                      style={{
                        background: "linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,255,255,0.03) 100%)",
                        border: "1px solid rgba(255,255,255,0.2)",
                      }}
                    >
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" className="h-9 w-9 text-white" aria-hidden>
                  ...
                  <form className="space-y-6" noValidate onSubmit={handleSubmit}>
                    ...
                    {error && (
                      ...
                      >
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" className="mt-0.5 h-4 w-4 shrink-0 text-red-400" aria-hidden>
                          <circle cx="12" cy="12" r="10" /><path d="M12 8v4M12 16h.01" />
                        </svg>

      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Ionicons name="play-circle-outline" size={48} color={themeColors.muted} />
            <Text style={styles.emptyTitle}>No sessions in progress</Text>
            <Text style={styles.emptyText}>
              Start watching any show or movie, and pick up right where you left off.
            </Text>
            <Pressable
              style={styles.exploreButton}
              onPress={() => router.push("/(tabs)/explore")}
            >
              <Text style={styles.exploreButtonText}>Browse content</Text>
            </Pressable>
          </View>
        }
      />
